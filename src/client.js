/**
 * dsh-ergonomics — Client half.
 *
 * Runs inside the DSH browser shell. Two features live here:
 *
 ...
 *      to a new session.
 *
 * `React` and `styles` are ambient symbols injected by the DSH client runtime
 * (no `import` is available in this scope).
 */
